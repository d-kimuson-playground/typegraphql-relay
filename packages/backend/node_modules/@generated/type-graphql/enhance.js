...
const outputsInfo = {
    ...
    TaskGroupBy: ["id", "title", "detail", "isCompleted", "createdAt", "_count", "_min", "_max"],
...
const inputsInfo = {
    ...
    TaskOrderByWithAggregationInput: ["id", "title", "detail", "isCompleted", "createdAt", "_count", "_max", "_min"],
    TaskScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "detail", "isCompleted", "createdAt"],
    TaskCreateInput: ["id", "title", "detail", "isCompleted", "createdAt"],
    TaskUpdateInput: ["id", "title", "detail", "isCompleted", "createdAt"],
    TaskUpdateManyMutationInput: ["id", "title", "detail", "isCompleted", "createdAt"],
