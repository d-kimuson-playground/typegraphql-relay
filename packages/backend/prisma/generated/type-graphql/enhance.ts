...
const crudResolversInfo = {
  Task: ["aggregateTask", "createOneTask", "deleteManyTask", "deleteOneTask", "findFirstTask", "findFirstTaskOrThrow", "tasks", "task", "getTask", "groupByTask", "updateManyTask", "updateOneTask", "upsertOneTask"]
};
const argsInfo = {
...
const modelsInfo = {
  Task: ["id", "title", "detail", "isCompleted", "createdAt"]
};
...
const outputsInfo = {
  ...
  TaskGroupBy: ["id", "title", "detail", "isCompleted", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  TaskCountAggregate: ["id", "title", "detail", "isCompleted", "createdAt", "_all"],
  TaskAvgAggregate: ["id"],
  TaskSumAggregate: ["id"],
  TaskMinAggregate: ["id", "title", "detail", "isCompleted", "createdAt"],
  TaskMaxAggregate: ["id", "title", "detail", "isCompleted", "createdAt"]
};
...
const inputsInfo = {
  TaskWhereInput: ["AND", "OR", "NOT", "id", "title", "detail", "isCompleted", "createdAt"],
  TaskOrderByWithRelationInput: ["id", "title", "detail", "isCompleted", "createdAt"],
  TaskWhereUniqueInput: ["id"],
  TaskOrderByWithAggregationInput: ["id", "title", "detail", "isCompleted", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
  TaskScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "detail", "isCompleted", "createdAt"],
  TaskCreateInput: ["title", "detail", "isCompleted", "createdAt"],
  TaskUpdateInput: ["title", "detail", "isCompleted", "createdAt"],
  TaskUpdateManyMutationInput: ["title", "detail", "isCompleted", "createdAt"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  StringFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "not"],
  BoolFilter: ["equals", "not"],
  DateTimeFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  TaskCountOrderByAggregateInput: ["id", "title", "detail", "isCompleted", "createdAt"],
  TaskAvgOrderByAggregateInput: ["id"],
  TaskMaxOrderByAggregateInput: ["id", "title", "detail", "isCompleted", "createdAt"],
  TaskMinOrderByAggregateInput: ["id", "title", "detail", "isCompleted", "createdAt"],
  TaskSumOrderByAggregateInput: ["id"],
